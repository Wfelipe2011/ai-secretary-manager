...
describe('AppController (e2e)', () => {
  ...
  it('should return mocked response from graph.invoke', async () => {
    const message_1 = 'olá'
    const message_2 = 'gostatia de agendar um corte de cabelo'
    const message_3 = 'pode ser amanhã às 10h?'

    const response_1 = await ivoke(message_1)
    const response_2 = await ivoke(message_2)
    const response_3 = await ivoke(message_3)
    ...
    console.log('User:', message_3);
    console.log('AI:', response_3);
